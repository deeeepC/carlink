...
// bus num: CAN Bus numbers in carlink, sent to/from USB
...
// Helpers
// CarLink:       Bus 0=CAN1   Bus 1=CAN2   Bus 2=CAN3
...
void can_init_all(void) {
  for (uint8_t i=0U; i < CARLINK_CAN_CNT; i++) {
