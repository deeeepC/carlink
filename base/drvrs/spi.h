...
uint16_t spi_version_packet(uint8_t *out) {
  ...
  // the carlink's SPI protocol. its contents match that of the
  // carlink USB descriptors and are sufficent to list/enumerate
  // a carlink, determine carlink type, and bootstub status.
