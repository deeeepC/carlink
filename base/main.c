...
#ifdef STM32H7
  #include "drvrs/fdcan.h"
#else
  #include "drvrs/bxcan.h"
#endif
...
int main(void) {
  ...
  // carlink has an FPU, let's use it!
  enable_fpu();
  ...
  while (true) {
    if (power_save_status == POWER_SAVE_STATUS_DISABLED) {
      ...
      #endif
        // useful for debugging, fade breaks = carlink is overloaded
