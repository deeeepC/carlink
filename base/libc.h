// **** libc ****
#include <stdint.h> // Include for uint32_t and uintptr_t
...
// Custom implementations are renamed to avoid conflicts with the standard library
...
int my_memcmp(const void *ptr1, const void *ptr2, unsigned int num) {
  int ret = 0;
